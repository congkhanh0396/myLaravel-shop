	...
	<div class="container">
		...
		<div class="cart-gd">
			...
			<div class="cart-header">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						<img src="source/images/l1.jpg" class="img-responsive" alt="">
					</div>
			...
			<div class="cart-header2">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						<img src="source/images/l2.jpg" class="img-responsive" alt="">
					</div>
					<div class="cart-item-info">
						<h3><a href="#"> Lorem Ipsum is not simply </a><span>Pickup time:</span></h3>
						<ul class="qty">
			...
			<div class="cart-header3">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						<img src="source/images/l3.jpg" class="img-responsive" alt="">
					</div>
					<div class="cart-item-info">
						<h3><a href="#"> Lorem Ipsum is not simply </a><span>Pickup time:</span></h3>
						<ul class="qty">
